...
void delete_info()
{
    ...
    else
    {
        ...
        query_result[2] -> prev = query_result[0];
        free(query_result[1]);
    }
...
void update_info()
{
    ...
    else if (query_result[0] == NULL)
    {
        ...
        head -> prev = _insertable;
        head = _insertable;
    }
    else if (query_result[2] == NULL)
    {
        query_result[2] -> next = _insertable;
        _insertable -> prev = query_result[2];
    }
    else
    { 
        query_result[0] -> next = _insertable;
        _insertable -> prev = query_result[0];
        _insertable -> next = query_result[1];
        query_result[1] -> prev = _insertable;
    }
}
