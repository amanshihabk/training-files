...
void read_info(struct EmployeeDatabase *entry);
void show_info(int8_t index, struct EmployeeDatabase *db);
void update_info(struct EmployeeDatabase *db, int32_t index);
